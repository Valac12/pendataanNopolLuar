                ...
                <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="TanggalLogin" type="text" value="{{ $userId->tgl_login }}" readonly>
                            </div>
                            <!-- Form Group Tanggal Logout-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="TanggalLogout">Tanggal Logout</label>
                                <input class="form-control" id="TanggalLogout" type="text" value="{{$userId->tgl_logout }}" readonly>
                            </div>
                        </div>
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/kelolaAdmin/{{ $userId->id }}" method="post" class="was-validated needs-validation" novalidate>
          @method('put')
            @csrf
